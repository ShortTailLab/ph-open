...
- (void)cancelRequestProductData
{
    if (productRequest_)
    {
        ...
        productRequest_ = nil;
        if (productRequestDelegate_)
            productRequestDelegate_->requestProductsFailed(CCStoreProductsRequestErrorCancelled, "CCStoreProductsRequestErrorCancelled");

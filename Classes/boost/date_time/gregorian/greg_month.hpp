...
namespace gregorian {
  ...
  public:
    ...
    const char* as_short_string() const { return "HACK: this is not supported. We are not linking against libboost_date_time.a"; }
    const char* as_long_string()  const { return "HACK: this is not supported. We are not linking against libboost_date_time.a"; }

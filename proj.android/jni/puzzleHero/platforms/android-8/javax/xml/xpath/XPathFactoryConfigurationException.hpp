...
javax::xml::xpath::XPathFactoryConfigurationException::operator local_ref<java::lang::Object>() const
{
	return local_ref<java::lang::Object>(get_jobject());
}

javax::xml::xpath::XPathFactoryConfigurationException::operator local_ref<java::lang::Exception>() const
{
	return local_ref<java::lang::Exception>(get_jobject());
}

javax::xml::xpath::XPathFactoryConfigurationException::operator local_ref<java::lang::Throwable>() const
{
	return local_ref<java::lang::Throwable>(get_jobject());
}

javax::xml::xpath::XPathFactoryConfigurationException::operator local_ref<java::io::Serializable>() const
{
